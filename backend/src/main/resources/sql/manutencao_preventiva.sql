...
ALTER TABLE peca
    ...
    ADD COLUMN IF NOT EXISTS viscosidade_sae VARCHAR(30) NULL,
    ADD COLUMN IF NOT EXISTS classificacao_api VARCHAR(50) NULL,
    ADD COLUMN IF NOT EXISTS classificacao_acea VARCHAR(80) NULL,
    ADD COLUMN IF NOT EXISTS norma_oem VARCHAR(200) NULL,
